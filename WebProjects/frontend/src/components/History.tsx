...
const History: FunctionComponent = () => {
  return (
    <SecondChildFrameRoot>
      <UnionIcon loading="eager" alt="" src="/union.svg"/>
      <UnionIcon1 loading="eager" alt="" src="/union.svg"/>
      <ThirdChildFrame>
        <DonorSearchText>
          <CompanyHistory>
            <Donorsearch>Donorsearch</Donorsearch>
            <CompanyHistoryChild loading="eager" alt="" src="/redVector.svg"/>
            <FrameWithinFrame>
              <FrameWithText>
                <Div>
          ...
          <AchievementsFrame>
            <AchievementsFrameChild loading="eager" alt="" src="/sobakaFonFrame.svg"/>
            <UnionIcon2 loading="eager" alt="" src="/union.svg"/>
            <UnionIcon3 loading="eager" alt="" src="/union.svg"/>
          </AchievementsFrame>
        </DonorSearchText>
      </ThirdChildFrame>
      <UnionIcon4 loading="eager" alt="" src="/union.svg"/>
      <H>Наши достижения</H>
    </SecondChildFrameRoot>
  );
};
