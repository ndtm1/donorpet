  ...
  return (
    <FrameParentRoot>
      <WorldwideUsersFrameParent>
        <WorldwideUsersFrame>
          <WorldwideUsersFrameChild loading="eager" alt="" src="/blobOdin.svg"/>
          <WorldwideWebUsersIcon loading="eager" alt="" src="/worldwide-web-users.svg"/>
        </WorldwideUsersFrame>
        <Div>
          <Span>
      ...
      <FrameInstanceParent>
        <FrameInstance>
          <RectangleVector>
            <RectangleVectorChild loading="eager" alt="" src="/blobDva.svg"/>
            <MobilePhoneHandHoldIcon loading="eager" alt="" src="/mobile-phone-hand-hold.svg"/>
          </RectangleVector>
        </FrameInstance>
        <Div1>
      ...
      <FrameGroupsParent>
        <FrameGroups>
          <FrameGroupsChild loading="eager" alt="" src="/blobTri.svg"/>
          <BusinessDealHandshakeIcon loading="eager" alt="" src="/business-deal-handshake.svg"/>
        </FrameGroups>
        <Div2>
