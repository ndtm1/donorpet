...
public class SmsAeroClient {
        ...
        for (int i = 0; i < urlsLen; i++) {
            try {
                ...
                return _doSendRequest(method, form);
                    ...
                    PortUnreachableException | ProtocolException | SocketTimeoutException | UnknownHostException |
                    UnknownServiceException | org.json.simple.parser.ParseException
                e
            ) {
                if(urlsLen == (i + 1)) {
    ...
    private JSONObject _doSendRequest(String method, Map<String, String> form) throws IOException, ParseException, org.json.simple.parser.ParseException {
